...
##' @param owner user or organization who owns the GitHub repository
...
##' @export
##' @md
one_issue_per_file <- function(owner, repo,
...
if (FALSE) {
  ...
  one_issue_per_file(
    owner = "carpentries-es",
    repo = "python-ecology-lesson-es",
    path = "_episodes",
    pattern = "md$",
    issue_title = "Translation of {name}",
